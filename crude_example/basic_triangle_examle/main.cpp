...
//#endif
//  crude::Shared_Ptr<graphics::Instance>                                m_instance;
//  crude::Shared_Ptr<graphics::Debug_Utils_Messenger>                   m_debugUtilsMessenger;
//  crude::Shared_Ptr<graphics::Surface>                                 m_surface;
//  crude::Shared_Ptr<graphics::Physical_Device>                         m_physicalDevice;
//  crude::Shared_Ptr<graphics::Device>                                  m_device;
//  crude::Shared_Ptr<graphics::Queue>                                   m_graphicsQueue;
//  crude::Shared_Ptr<graphics::Queue>                                   m_presentQueue;
//  crude::Shared_Ptr<graphics::Swap_Chain>                              m_swapchain;
//  crude::vector<crude::Shared_Ptr<graphics::Swap_Chain_Image>>  m_swapchainImages;
//  crude::vector<crude::Shared_Ptr<graphics::Image_View>>        m_swapchainImagesViews;
//  crude::Shared_Ptr<graphics::Render_Pass>                             m_renderPass;
//  crude::Shared_Ptr<graphics::Descriptor_Set_Layout>                   m_descriptorSetLayout;
//  crude::Shared_Ptr<graphics::Pipeline_Layout>                         m_pipelineLayout;
//  crude::Shared_Ptr<graphics::Pipeline>                                m_graphicsPipeline;
//  crude::Shared_Ptr<graphics::Command_Pool>                            m_commandPool;
//  crude::Shared_Ptr<graphics::Device_Memory>                           m_depthImageDeviceMemory;
//  crude::Shared_Ptr<graphics::Image>                                   m_depthImage;
//  crude::Shared_Ptr<graphics::Image_View>                              m_depthImageView;
//  crude::vector<crude::Shared_Ptr<graphics::Framebuffer>>       m_swapchainFramebuffers;
//  crude::Shared_Ptr<graphics::Image>                                   m_textureImage;
//  crude::Shared_Ptr<graphics::Device_Memory>                           m_textureImageMemory;
//  crude::Shared_Ptr<graphics::Image_View>                              m_textureImageView;
//  crude::Shared_Ptr<graphics::Sampler>                                 m_sampler;
//  crude::Shared_Ptr<graphics::Descriptor_Pool>                         m_descriptorPool;
//  crude::vector<crude::Shared_Ptr<graphics::Descriptor_Set>>    m_descriptorSets;
//  crude::vector<crude::Shared_Ptr<graphics::Command_Buffer>>    m_commandBuffers;
//  crude::vector<crude::Shared_Ptr<graphics::Semaphore>>         m_imageAvailableSemaphores;
//  crude::vector<crude::Shared_Ptr<graphics::Semaphore>>         m_renderFinishedSemaphores;
//  crude::vector<crude::Shared_Ptr<graphics::Fence>>             m_inFlightFences;
