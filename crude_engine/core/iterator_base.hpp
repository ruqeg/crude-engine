...
template<class T>
class Contiguous_Iterator_Interface_Base
{
public:
...
{
public:
  using My_Class = Bidirectional_Iterator_Base<Concrete_Iterator, Type, Interface>;
  ...
  Bidirectional_Iterator_Base() noexcept;
  Bidirectional_Iterator_Base(Pointer ptr) noexcept;
  Bidirectional_Iterator_Base(const Concrete_Iterator& other) noexcept;
...
template <class Concrete_Iterator, 
          class Type, 
          class Interface = Contiguous_Iterator_Interface_Base<Type>>
class Contiguous_Iterator_Base // !TODO : public Bidirectional_Iterator_Base<Concrete_Iterator, Type, Interface>
{
public:
...
#include <core/iterator_base.inl>