...
module crude.resources.gltf_loader_system;
...
{
  GLTF_Loader_Context* ctx = it.ctx<GLTF_Loader_Context>();
  while (it.next())
  {
    auto metadata = it.field<crude::resources::GLTF_Metadata_Component>(0);
