...
public:
  ...
  core::shared_ptr<Color_Attachment> getMetallicRoughnessAttachment();
  core::shared_ptr<Image_View> getMetallicRoughnessAttachmentView();
  core::shared_ptr<Color_Attachment> getNormalAttachment();
  core::shared_ptr<Image_View> getNormalAttachmentView();
...
private:
  ...
  core::shared_ptr<Color_Attachment>          m_metallicRoughnessAttachment;
  core::shared_ptr<Image_View>                m_metallicRoughnessAttachmentView;
  core::shared_ptr<Color_Attachment>          m_normalAttachment;
  core::shared_ptr<Image_View>                m_normalAttachmentView;
