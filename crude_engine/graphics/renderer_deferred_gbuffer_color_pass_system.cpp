...
module crude.graphics.renderer_deferred_gbuffer_color_pass_system;
...
core::shared_ptr<Descriptor_Set_Layout> Renderer_Deferred_GBuffer_Color_Pass_Systen_Ctx::createDescriptorSetLayout()
{
  core::shared_ptr<Renderer_Core_System_Ctx> coreCtx = frameCtx->coreCtx;
...
core::array<Subpass_Description, 1> Renderer_Deferred_GBuffer_Color_Pass_Systen_Ctx::getSubpassDescriptions()
{
  return
  {
...
core::vector<Attachment_Description> Renderer_Deferred_GBuffer_Color_Pass_Systen_Ctx::getAttachmentsDescriptions()
{
  return
  {
...
core::vector<core::shared_ptr<Image_View>> Renderer_Deferred_GBuffer_Color_Pass_Systen_Ctx::getFramebufferAttachments()
{
  return { gbuffer->getAlbedoAttachmentView(), gbuffer->getDepthStencilAttachmentView() };
}

Color_Blend_State_Create_Info Renderer_Deferred_GBuffer_Color_Pass_Systen_Ctx::createColorBlendStateCreateInfo()
{
...
Depth_Stencil_State_Create_Info Renderer_Deferred_GBuffer_Color_Pass_Systen_Ctx::createDepthStencilStateCreateInfo()
{
