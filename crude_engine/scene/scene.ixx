...
{
public:
  void addNode(core::shared_ptr<Node2> node) { m_nodes.push_back(node); }
  const core::vector<core::shared_ptr<Node2>>& getNodes() const { return m_nodes; }
  flecs::world& getWorld() { return m_world; }
private:
  core::vector<core::shared_ptr<Node2>>  m_nodes;
  core::shared_ptr<Node2>                m_root;
  flecs::world                          m_world;
};
