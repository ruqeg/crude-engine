...
LIBSOURCELIST = $(LIBDIR)swap_chain.cpp $(LIBDIR)device.cpp $(LIBDIR)queue.cpp $(LIBDIR)physical_device.cpp $(LIBDIR)surface.cpp $(LIBDIR)debug_utils_messenger.cpp $(LIBDIR)instance.cpp $(LIBDIR)application.cpp
