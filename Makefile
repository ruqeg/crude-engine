...
LIBSOURCELIST = $(LIBDIR)render_pass.cpp $(LIBDIR)image_view.cpp $(LIBDIR)image.cpp $(LIBDIR)swap_chain_image.cpp $(LIBDIR)swap_chain.cpp $(LIBDIR)device.cpp $(LIBDIR)queue.cpp $(LIBDIR)physical_device.cpp $(LIBDIR)surface.cpp $(LIBDIR)debug_utils_messenger.cpp $(LIBDIR)instance.cpp $(LIBDIR)application.cpp
