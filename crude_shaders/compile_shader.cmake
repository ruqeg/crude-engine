macro(COMPILE_SHADER SHADER_FILE)
  ...
  set(SHADER_HEADER_NAME "${SHADER_FOLDER}/include/crude_shaders/${SHADER_NAME}.hpp")
  add_custom_command(
    COMMAND ${CMAKE_COMMAND} -DCONFIG_FILE="${CMAKE_CURRENT_SOURCE_DIR}/shader_data.inl.in" -DTARGET_NAME="crude_shaders" -DSHADER_FILE="${SHADER_FILE}" -DSHADER_SPIRV="${COMPILE_SPIRV_SHADER_RETURN}" -DSHADER_HEADER_NAME="${SHADER_HEADER_NAME}" -P ${CMAKE_CURRENT_SOURCE_DIR}/create_shader_header.cmake
